...
```bash
git clone https://github.com/adnan-jahangir/EZ-Trails-Sitakunda.git
cd EZ-Trails-Sitakunda
```
...
└── server/
    ...
    └── middleware/          # JWT Auth, Rate-limiter & Zod Validator
```
...
**Adnan Jahangir**  
* GitHub: [@adnan-jahangir](https://github.com/adnan-jahangir)
* Project Repo: [EZ-Trails-Sitakunda](https://github.com/adnan-jahangir/EZ-Trails-Sitakunda)
